...
- **Live Timing** — connects to OpenF1 API during active race weekends (free, no sign-up)
...
- **Data**: FastF1 (historical) + OpenF1 API (live)
...
- `GET /api/live/session` — check for active live session
